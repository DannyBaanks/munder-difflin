...
# Munder Difflin Fork ISyCo v0.4.6-ISyCo.1

> Build del fork [DannyBaanks/munder-difflin](https://github.com/DannyBaanks/munder-difflin):
> español primero, canal de control local, launcher Linux, supervisión de entrega,
> CLI `munder` y avatar inyectable. Detalle en el [README](./README.md).
> Lo de abajo son las notas del upstream v0.4.6 sobre el que está construido.

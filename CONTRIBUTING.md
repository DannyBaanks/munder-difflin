...
Screenshots and recordings are welcome when they make a visual change easier to
review, but they are optional. Describe the behavior you checked in the PR;
GitHub Actions is the cross-platform authority and runs the build and test
matrix on Windows, Linux, and macOS.

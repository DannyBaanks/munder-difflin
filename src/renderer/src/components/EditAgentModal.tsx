      ...
      <div onClick={(e) => e.stopPropagation()} style={{ width: 940, maxWidth: '95vw' }}>
        <PixelPanel variant="dialog" title={t('editAgent.title')} style={{ padding: 16 }} noPadding>
          <div style={{
            ...
            <Section label={t('editAgent.sectionIdentity')} hint={t('editAgent.hintIdentity')}>
              <Row label={t('editAgent.rowName')}>
                <input
                  value={name}
              ...
              <Row label={t('editAgent.rowColor')}>
            ...
            <Section label={t('editAgent.sectionEngine')} hint={t('editAgent.hintEngine')}>
              <Row label={t('editAgent.rowProvider')}>
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              ...
              {preset.supportsModel && (
                <Row label={t('editAgent.rowModel')}>
                  <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                    {(() => {
            ...
            <Section label={t('editAgent.sectionBriefing')} hint={t('editAgent.hintBriefing')}>
              <Row label={t('editAgent.rowDescription')}>
                <input
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  placeholder={t('editAgent.descPlaceholder')}
                  style={inputStyle}
                />
              </Row>

              <Row label={t('editAgent.rowGoal')}>
                <textarea
                  value={goal}
